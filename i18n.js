const translations = {
  en: {
    ...
    option_solution: "You develop an innovative solution for the proposed domains",
    option_demo: "You provide a new tool for use, with a live demo",
  ...
  ar: {
    ...
    option_solution: "تبتكرون حل للمجالات المطروحة",
    option_demo: "تقدمون أداة جديدة للاستخدام مع عرض توضيحي (ديمو)",
